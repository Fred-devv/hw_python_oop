class InfoMessage:
    ...
    def get_message(self) -> None:
        """Метод, который возвращает строку сообщения о проделанной тренировке. """
...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return ((self.COEFF_RUNNING_CALORIES * self.get_mean_speed() - self.SWIMMING_SPEED_INCREMENT)
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        """Формула для расчёта израсходованных калорий при спортивной ходьбе. """
